  ...
  const steps = [
    {
      ...
      body: 'Install Tailscale on the machine running MyOffice, then sign in.',
    ...
    },
    {
      ...
      body: 'MyOffice can talk to any OpenAI-compatible backend on mobile too. Make sure both the workspace and backend stay reachable over Tailscale or your local network.',
    ...
    {
      title: 'Open MyOffice on your phone',
      body:
