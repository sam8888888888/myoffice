...
function IntegrationsSection() {
  ...
  return (
    ...
    <SettingsSection
      title="Integrations"
      description="Connect external services used by MyOffice features."
      icon={SparklesIcon}
    >
      <SettingsRow
...
function ChatDisplaySection() {
  ...
  return (
    <>
      ...
      {/* Mobile Navigation removed — not relevant for MyOffice */}
    </>
  )
}
      ...
      <div style={sectionStyle}>
        ...
        >
          <p style={{ ...headingStyle, fontWeight: 400, ...muteStyle }}>
            You can still start MyOffice manually:
          </p>
          <pre
            style={{
              background: 'var(--theme-surface)',
