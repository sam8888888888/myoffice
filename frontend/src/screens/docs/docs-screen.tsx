    ...
    <div className="flex h-full flex-col overflow-y-auto" style={{ background: 'var(--theme-bg)' }}>
      <div className="mx-auto w-full max-w-5xl px-6 py-10">
        ...
        <section id="overview" style={sectionStyle}>
          ...
          <h3 style={h3Style}>What is MyOffice</h3>
          <p style={pStyle}>
            MyOffice is a full-featured web-based control panel for managing, monitoring, and orchestrating AI agents running on the Hermes Gateway. It provides a rich graphical interface for chat, multi-agent coordination, task tracking, memory management, skill installation, cron job scheduling, and system observability. The application is designed as a single-page progressive web app that connects to one or more Hermes Gateway instances via HTTP and Server-Sent Events (SSE).
          </p>

          <h3 style={h3Style}>Architecture</h3>
          <p style={pStyle}>
            MyOffice is built on a modern full-stack TypeScript architecture:
          </p>
          <ul style={ulStyle}>
          ...
          <p style={pStyle}>
            MyOffice does not directly communicate with LLM providers. Instead, it connects to a Hermes Gateway server that manages agent sessions, tool execution, memory, and provider routing. The connection model works as follows:
          </p>
          <ol style={olStyle}>
        ...
        <section id="screens-reference" style={sectionStyle}>
          ...
          <p style={pStyle}>
            MyOffice contains 18 distinct screens, each accessible via the sidebar navigation or keyboard shortcuts. Below is a reference for each screen.
          </p>
        ...
        <section id="chat-system" style={sectionStyle}>
          ...
          <p style={pStyle}>
            Every conversation in MyOffice exists within a session. Sessions are server-managed entities created on the Hermes Gateway. Each session maintains its own context window, message history, tool permissions, and memory state.
          </p>
          <ul style={ulStyle}>
        ...
        <section id="multi-agent" style={sectionStyle}>
          ...
          <p style={pStyle}>
            MyOffice includes 7 built-in crew templates plus support for user-created custom templates. Templates are categorized:
          </p>
          <ul style={ulStyle}>
        ...
        <section id="task-management" style={sectionStyle}>
          ...
          <p style={pStyle}>
            Tasks integrate with other MyOffice systems:
          </p>
          <ul style={ulStyle}>
        ...
        <section id="cron-jobs" style={sectionStyle}>
          ...
          <p style={pStyle}>
            Cron jobs in MyOffice follow a lifecycle:
          </p>
          <ol style={olStyle}>
        ...
        <section id="agent-library" style={sectionStyle}>
          ...
          <p style={pStyle}>
            MyOffice ships with 8 built-in agent personas, each specialized for different task types:
          </p>
          <table style={tableStyle}>
            <thead>
              <tr>
        ...
        <section id="api-reference" style={sectionStyle}>
          ...
          <p style={pStyle}>
            All API endpoints are served by the MyOffice server process and proxy to the Hermes Gateway where appropriate. Base path: <code style={codeStyle}>/api</code>. All mutating endpoints require <code style={codeStyle}>Content-Type: application/json</code>. Authentication is via session cookie or Bearer token.
          </p>
...
jobs:
  ...
  "supervised": false            // Require approvals for workers
          ...
          <p style={pStyle}>
            Several data stores use the <code style={codeStyle}>.runtime/</code> directory within the MyOffice installation:
          </p>
          <dl style={dlStyle}>
          ...
          <table style={tableStyle}>
            ...
            <tbody>
              ...
              <tr><td style={tdCodeStyle}>HERMES_PASSWORD</td><td style={tdStyle}>(none)</td><td style={tdStyle}>Password required to log into MyOffice. When set, the login screen is shown on first visit.</td></tr>
              ...
              <tr><td style={tdCodeStyle}>PORT</td><td style={tdCodeStyle}>3000</td><td style={tdStyle}>Port number for the MyOffice server.</td></tr>
            </tbody>
          </table>
        </section>
        ...
        <section id="design-system" style={sectionStyle}>
          ...
          <p style={pStyle}>
            MyOffice uses a CSS custom property theming system with 5 available themes. Themes are applied by setting the <code style={codeStyle}>data-theme</code> attribute on the document root. All themes operate in dark mode only.
          </p>
          <table style={tableStyle}>
            <thead>
          ...
          <p style={pStyle}>
            MyOffice uses a design system component library for consistent UI patterns:
          </p>
          <dl style={dlStyle}>
          ...
          <p style={pStyle}>
            MyOffice uses <strong>HugeIcons</strong> (<code style={codeStyle}>@hugeicons/react</code> with <code style={codeStyle}>@hugeicons/core-free-icons</code>) as its primary icon library. Icons are imported individually by name and rendered via the <code style={codeStyle}>HugeiconsIcon</code> component. The icon set provides consistent 24px stroke icons with adjustable size and color props.
          </p>
        ...
        <section id="gateway-integration" style={sectionStyle}>
          ...
          <p style={pStyle}>
            On server startup and periodically every 120 seconds, MyOffice probes the configured gateway to determine available API groups. The probing process:
          </p>
          <ol style={olStyle}>
        ...
        <section id="security" style={sectionStyle}>
          ...
          <p style={pStyle}>
            MyOffice supports multiple authentication methods:
          </p>
          <ul style={ulStyle}>
        ...
        <section id="keyboard-shortcuts" style={sectionStyle}>
          ...
          <p style={pStyle}>
            MyOffice provides keyboard shortcuts for fast navigation and common actions. Modifier keys: Ctrl on Windows/Linux, Cmd on macOS.
          </p>
        ...
        <div style={{ textAlign: 'center', padding: '2rem 0', color: 'var(--theme-muted)', fontSize: '0.85rem' }}>
          <p>MyOffice Documentation v1.20.0</p>
