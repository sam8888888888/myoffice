    ...
    <div className="flex h-full flex-col overflow-y-auto" style={{ background: 'var(--theme-bg)' }}>
      <div className="mx-auto w-full max-w-4xl px-6 py-10">
        ...
        <p style={{ color: 'var(--theme-muted)', fontSize: '1.1rem', marginBottom: '2.5rem' }}>
          A comprehensive guide to every feature in MyOffice. Use the table of contents below to jump to any section.
        </p>
        ...
        <section id="getting-started" style={sectionStyle}>
          ...
          <p style={pStyle}>
            MyOffice communicates with your AI agents through the Hermes Gateway server. Before you can use any features, you need to establish a connection.
          </p>
          <ol style={olStyle}>
          ...
          <p style={pStyle}>
            When you first launch MyOffice, a setup wizard may appear to guide you through initial configuration. If it does not appear, follow these steps:
          </p>
          <ol style={olStyle}>
        ...
        <section id="files-terminal" style={sectionStyle}>
          ...
          <p style={pStyle}>
            The integrated terminal gives you a shell directly within MyOffice:
          </p>
          <ol style={olStyle}>
        ...
        <section id="settings" style={sectionStyle}>
          ...
          <p style={pStyle}>
            Configure how MyOffice connects to your gateway:
          </p>
          <ul style={ulStyle}>
          ...
          <p style={pStyle}>
            Customize the visual appearance of MyOffice:
          </p>
          <ul style={ulStyle}>
        ...
        <section id="keyboard-shortcuts" style={sectionStyle}>
          ...
          <p style={pStyle}>
            MyOffice supports keyboard shortcuts for quick navigation and common actions. Below is the full reference:
          </p>
        ...
        <footer style={{ textAlign: 'center', padding: '2rem 0', borderTop: '1px solid var(--theme-border-subtle)', color: 'var(--theme-muted)', fontSize: '0.85rem' }}>
          <p>MyOffice Help - Last updated April 2026</p>
        </footer>
      </div>
    </div>
  )
