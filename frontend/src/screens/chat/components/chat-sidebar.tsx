...
function ChatSidebarComponent({
  ...
  const isJobsActive = pathname === '/jobs' || pathname === '/jobs-all'
...
// ── Nav definitions ─────────────────────────────────────────────────
  ...
  const isHandoffsActive = pathname === '/handoffs'
  const isTeamActive = pathname === '/team'
  const isBoardActive = pathname === '/board'
  const isBrainActive = pathname === '/brain'
  const isHrActive = pathname === '/hr'
